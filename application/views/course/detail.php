    		...
    		<div class="col-md-4">
    			<div class="card">
				  	...
				  	<ul class="list-group list-group-flush">				    
    					<?php foreach ($materi as $row) : ?>
    						<li class="list-group-item">
	    						<a href="<?= base_url('course/detailMateri/') . $row['id']; ?>" class="card-link">
	    							<?= $row['judul']; ?>
	  							</a>
  							</li>
    					<?php endforeach; ?>				  						
				  ...
				  <div class="card-footer">
				  	<a href="<?= base_url('course/addMateri/') . $course['0']['id_kursus']; ?>" class="btn btn-sm btn-success">Buat Materi?</a>
				  </div>
				</div>
    		</div>	
    		<div class="col-md-4">
