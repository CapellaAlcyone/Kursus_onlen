    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <a class="navbar-brand" href="#"><img src="<?php echo base_url()?>assets/img/ikbal2.png"></a>
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="<?php echo base_url('siswa')?>">Home</a></li>
            <li><a href="<?php echo base_url('siswa/profile')?>"><i class="glyphicon glyphicon-user"></i> Profile</a></li>
            <li><a href="<?php echo base_url('siswa/publish')?>"><i class="glyphicon glyphicon-briefcase"></i> Daftar kursus</a></li>
            <li><a href="<?php echo base_url('siswa/keranjang')?>"><i class="glyphicon glyphicon-briefcase"></i> Keranjang Belanja</a></li>
            <li><a href="<?php echo base_url()?>auth/logout"><i class="glyphicon glyphicon-shopping-cart"></i>  Logout</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
            ...
            <a href="<?php echo base_url()?>shopping/index/" class="list-group-item">Semua</a>
          	<?php
		          	foreach ($genre as $row)
						{
			?>
            <a href="<?php echo base_url()?>shopping/index/<?php echo $row['id'];?>" class="list-group-item"><?php echo $row['nama_genre'];?></a>
            <?php
						}
			?>
          </div><br>
